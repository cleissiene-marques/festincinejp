...
export const metadata: Metadata = {
  title: "Quem Somos",
  description: "Conheça a Festin Cine JP IPTV: um serviço focado em estabilidade, qualidade de imagem e suporte humano de verdade para quem quer assistir sem travar.",
  alternates: { canonical: "/quem-somos/" },
  openGraph: {
    url: "/quem-somos/",
    title: "Quem Somos | Festin Cine JP IPTV",
    description: "Conheça a Festin Cine JP IPTV: um serviço focado em estabilidade, qualidade de imagem e suporte humano de verdade para quem quer assistir sem travar.",
  },
  twitter: {
    title: "Quem Somos | Festin Cine JP IPTV",
    ...
    <>
      ...
      <section className="section" aria-labelledby="story-heading">
        <div className="container">
          ...
          <h2 className="section-heading" id="story-heading" style={{ marginTop: "16px" }}>Por que a Festin Cine JP existe</h2>
          <div className="legal-content" style={{ marginTop: "32px" }}>
            <p>A Festin Cine JP IPTV nasceu de um problema simples de descrever e chato de viver: serviço de streaming que trava justamente na hora que mais importa — no jogo decisivo, na estreia da série, no fim de semana em família.</p>
