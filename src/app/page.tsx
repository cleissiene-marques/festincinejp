...
export const metadata: Metadata = {
  title: "Festin Cine JP IPTV – Teste Grátis | IPTV Estável em HD, Full HD e 4K",
  description:
    "Festin Cine JP IPTV: transmissão estável em HD, Full HD e 4K com suporte humano no WhatsApp todos os dias. Peça seu teste grátis agora. Planos a partir de R$ 25/mês, sem fidelidade.",
  alternates: { canonical: "/" },
  openGraph: {
    url: "/",
    title: "Festin Cine JP IPTV – Teste Grátis | IPTV Estável em HD, Full HD e 4K",
    description:
      "Festin Cine JP IPTV: transmissão estável em HD, Full HD e 4K com suporte humano no WhatsApp. Peça seu teste grátis agora. Planos a partir de R$ 25/mês, sem fidelidade.",
  },
  twitter: {
    title: "Festin Cine JP IPTV – Teste Grátis | IPTV Estável em HD, Full HD e 4K",
    description: "Festin Cine JP IPTV: transmissão estável em HD, Full HD e 4K com suporte humano no WhatsApp.",
  },
};

const homeFaqs = [
  {
    pergunta: "Como funciona o teste IPTV grátis da Festin Cine JP?",
    resposta:
  ...
  {
    pergunta: "Em quais aparelhos a Festin Cine JP IPTV funciona?",
    resposta:
...
const reviews = [
  {
    quote:
      "Já tinha passado por dois serviços antes e sempre travava justamente no segundo tempo do jogo. A Festin Cine JP é diferente — nem nos jogos de domingo à noite trava. Renovei pelo segundo semestre sem pensar duas vezes.",
    initials: "BT",
    name: "Bruno Tavares",
  ...
  {
    quote:
      "Somos quatro em casa e cada um quer uma coisa. Meu marido nos esportes, eu nas séries e as crianças nos desenhos. A Festin Cine JP tem tudo isso organizado direitinho. Sem briga pelo controle.",
    initials: "RS",
  ...
  {
    quote:
      "Assisto muito depois da meia-noite, depois que os pequenos dormem, e é justamente aí que outros serviços costumavam cair. Com a Festin Cine JP nunca precisei ficar reiniciando o app no meio de um filme.",
    initials: "GP",
    name: "Gustavo Pires",
...
export default function HomePage() {
  const productSchema = {
    ...
    brand: { "@id": "https://festincinejp.com.br/#organization" },
    aggregateRating: {
  ...
  return (
    <>
          ...
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <p className="hero-desc">
                A Festin Cine JP IPTV reúne canais ao vivo, filmes, séries, esportes e conteúdo infantil com transmissão firme nos horários de pico e suporte humano no WhatsApp todos os dias. Peça o teste, instale em minutos e só decida depois de ver funcionando na sua casa.
              </p>
      ...
      {/* ===== STATS STRIP ===== */}
      <section className="stats-strip" aria-label="Números da Festin Cine JP IPTV">
        <div className="container">
      ...
      <section className="section" aria-labelledby="benefits-heading">
        <div className="container">
          ...
          <h2 className="section-heading" id="benefits-heading" style={{ marginTop: "16px" }}>
            Por que escolher a Festin Cine JP IPTV
          </h2>
          ...
          <div className="diff-intro">
            <div>
              ...
              <h2 className="section-heading" id="diff-heading" style={{ marginTop: "16px" }}>
                Por que a Festin Cine JP é diferente de qualquer outro IPTV
              </h2>
            </div>
            <div>
              <p className="section-subtext" style={{ marginTop: 0 }}>
                Qualquer serviço promete estabilidade. A diferença aparece na rotina: no jogo de domingo às 22h, na madrugada de sábado, quando o sistema trava e você precisa de alguém. É aí que a Festin Cine JP se separa do resto.
              </p>
            </div>
          </div>
      ...
      <section className="section reviews-bg" aria-labelledby="reviews-heading">
        <div className="container">
          ...
          <h2 className="section-heading" id="reviews-heading" style={{ marginTop: "16px" }}>
            O que dizem os assinantes da Festin Cine JP IPTV
          </h2>
        ...
        <div className="container">
          <div style={{ textAlign: "center" }}>
            ...
            <h2 className="section-heading" id="faq-heading" style={{ marginTop: "16px" }}>
              Dúvidas sobre a Festin Cine JP IPTV
            </h2>
