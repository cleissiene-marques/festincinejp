...
export const metadata: Metadata = {
  title: "Contato",
  description: "Fale com a Festin Cine JP IPTV pelo WhatsApp ou e-mail. Atendimento humano todos os dias para tirar dúvidas, pedir teste grátis ou resolver problemas.",
  alternates: { canonical: "/contato/" },
  openGraph: {
    url: "/contato/",
    title: "Contato | Festin Cine JP IPTV",
    description: "Fale com a Festin Cine JP IPTV pelo WhatsApp ou e-mail. Atendimento humano todos os dias para tirar dúvidas, pedir teste grátis ou resolver problemas.",
  },
  twitter: {
    title: "Contato | Festin Cine JP IPTV",
