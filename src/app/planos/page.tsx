...
export const metadata: Metadata = {
  ...
  description:
    "Conheça os planos IPTV da Festin Cine JP: Mensal, Trimestral, Semestral e Anual, todos com acesso completo, sem fidelidade. Pagamento via Pix, cartão ou boleto.",
  alternates: { canonical: "/planos/" },
  openGraph: {
    url: "/planos/",
    title: "Planos IPTV a partir de R$ 25/mês | Festin Cine JP IPTV",
    description:
      "Conheça os planos IPTV da Festin Cine JP: Mensal, Trimestral, Semestral e Anual, todos com acesso completo, sem fidelidade. Pagamento via Pix, cartão ou boleto.",
  },
  twitter: {
