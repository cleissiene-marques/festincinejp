...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description: "Termos e condições de uso do serviço Festin Cine JP IPTV: contratação, pagamento, cancelamento, responsabilidades e limitações.",
  alternates: { canonical: "/termos-de-uso/" },
  openGraph: {
    url: "/termos-de-uso/",
    title: "Termos de Uso | Festin Cine JP IPTV",
    description: "Termos e condições de uso do serviço Festin Cine JP IPTV: contratação, pagamento, cancelamento, responsabilidades e limitações.",
  },
  twitter: {
    title: "Termos de Uso | Festin Cine JP IPTV",
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="legal-content">
            ...
            <p>A Festin Cine JP IPTV oferece tecnologia e suporte para acesso a conteúdo de streaming via aplicativo (player), compatível com Smart TVs, TV Box, celulares e outros dispositivos. O serviço depende de conexão de internet própria do usuário.</p>
            ...
            <p>A marca Festin Cine JP IPTV, o layout e os textos deste site são de uso exclusivo da empresa. É proibida a reprodução total ou parcial sem autorização prévia.</p>
