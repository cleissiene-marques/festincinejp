...
export const metadata: Metadata = {
  ...
  description: "Peça seu teste IPTV grátis da Festin Cine JP em minutos. Sem cartão de crédito, sem cadastro extenso. Veja a qualidade antes de contratar.",
  alternates: { canonical: "/teste-gratis/" },
  openGraph: {
    url: "/teste-gratis/",
    title: "Teste IPTV Grátis — Peça agora pelo WhatsApp | Festin Cine JP IPTV",
    description: "Peça seu teste IPTV grátis da Festin Cine JP em minutos. Sem cartão de crédito, sem cadastro extenso. Veja a qualidade antes de contratar.",
  },
  twitter: {
    title: "Teste IPTV Grátis — Peça agora pelo WhatsApp | Festin Cine JP IPTV",
