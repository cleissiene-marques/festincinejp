...
export const metadata: Metadata = {
  ...
  description: "Saiba como a Festin Cine JP IPTV coleta, usa e protege seus dados pessoais, em conformidade com a Lei Geral de Proteção de Dados (LGPD).",
  alternates: { canonical: "/politica-de-privacidade/" },
  openGraph: {
    url: "/politica-de-privacidade/",
    title: "Política de Privacidade | Festin Cine JP IPTV",
    description: "Saiba como a Festin Cine JP IPTV coleta, usa e protege seus dados pessoais, em conformidade com a Lei Geral de Proteção de Dados (LGPD).",
  },
  twitter: {
    title: "Política de Privacidade | Festin Cine JP IPTV",
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="legal-content">
            ...
            <h2>1. Quem somos</h2>
            <p>Esta política explica como a Festin Cine JP IPTV (festincinejp.com.br) coleta, usa e protege os dados pessoais de quem solicita informações, teste grátis ou contrata nossos planos, em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD).</p>
