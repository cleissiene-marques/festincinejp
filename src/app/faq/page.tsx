...
export const metadata: Metadata = {
  ...
  description:
    "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Festin Cine JP IPTV.",
  alternates: { canonical: "/faq/" },
  openGraph: {
    url: "/faq/",
    title: "Perguntas Frequentes sobre IPTV | Festin Cine JP IPTV",
    description:
      "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Festin Cine JP IPTV.",
  },
  twitter: {
  ...
  return (
    <>
      ...
      <section className="section" aria-labelledby="faq-list-heading">
        <div className="container">
          <h2 className="section-heading" id="faq-list-heading" style={{ textAlign: "center" }}>Dúvidas rápidas sobre a Festin Cine JP IPTV</h2>
