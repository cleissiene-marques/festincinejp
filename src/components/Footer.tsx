      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <Link href="/" className="logo" aria-label="Festin Cine JP IPTV — página inicial">
              <div className="logo-mark" aria-hidden="true">
                <LogoMarkIcon width={20} height={20} />
              </div>
              <span className="logo-name">
                Festin Cine JP <span>IPTV</span>
              </span>
            </Link>
        ...
        <div className="footer-bottom">
          <p>
            © 2026 Festin Cine JP IPTV · festincinejp.com.br · Todos os direitos reservados.
            <br />
